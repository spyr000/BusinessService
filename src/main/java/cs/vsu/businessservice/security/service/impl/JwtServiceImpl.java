...
public class JwtServiceImpl implements JwtService {
    ...
    public String generateToken(
        ...
        String expirationTime = tokenType.equals(TokenType.ACCESS)
                ? env.getProperty("security.encryption.access-token-expiration-time-millis")
                : env.getProperty("security.encryption.refresh-token-expiration-time-millis");
        return Jwts
                .builder()
    ...
    private Key getSignInKey(TokenType tokenType) {
        String encryptionKey = tokenType.equals(TokenType.ACCESS)
                ? env.getProperty("security.encryption.access-token-key")
                : env.getProperty("security.encryption.refresh-token-key");
